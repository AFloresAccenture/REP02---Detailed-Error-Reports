...
#	04-May-2015		EXT-08		Erwin Ramos				Modified to send email even without attachments	...added if [ "$new_filename" == "NONE" ]; then
...
# End AFlores
echo "parameter new_filename: " $new_filename
echo "parameter old_filename: " $old_filename
echo "parameter recipient: " $recipient
echo "parameter recipient_c: " $recipient_c
echo "parameter recipient_b: " $recipient_b
echo "parameter subject: " $subject
echo "parameter message: " $message
echo "parameter for LF10 New file name: " $lf10_new_filename
echo "parameter for LF10 New old name: " $lf10_old_filename
echo "parameter for LF11 New file name: " $lf11_new_filename
echo "parameter for LF11 New old name: " $lf11_old_filename
echo "parameter for LF14 New file name: " $lf14_new_filename
echo "parameter for LF14 New old name: " $lf14_old_filename
echo "parameter for LF16 New file name: " $lf16_new_filename
echo "parameter for LF16 New old name: " $lf16_old_filename
echo "parameter for LF17 New file name: " $lf17_new_filename
echo "parameter for LF17 New old name: " $lf17_old_filename
echo "parameter for LF19 New file name: " $lf19_new_filename
echo "parameter for LF19 New old name: " $lf19_old_filename
...
# if - else for the summary report
...
#send email script for error reports for loads
if [ ! -z "$rep02_output_file" ]; then
		echo "Sending email notification for error reports.."
		if [ -z "$recipient_c" ] && [ -z "$recipient_b" ]; then #No CC and BCC recipient(s)
...
#send email script for safety stocks error report	
else 
