create or replace PACKAGE BODY       XXNBTY_VCP_ON_HAND_ERROR_PKG 
 ---------------------------------------------------------------------------------------------
  /*
  Package Name	: XXNBTY_VCP_ON_HAND_ERROR_PKG
  ...
  IS
   ...
   v_child_request_id 	NUMBER; 
		...
		SELECT  PLAN_ID                           
				...
				process_flag = 3 AND order_type = 18 AND TRUNC(creation_date) = TRUNC(SYSDATE) AND abs(request_id) >= p_main_request_id;
...
END XXNBTY_VCP_ON_HAND_ERROR_PKG;