  ...
  IS
   ...
   BEGIN
	...
	v_step := 3;	
		...
		FND_FILE.PUT_LINE(FND_FILE.OUTPUT,'ERROR_DESCRIPTION ,ITEM_NAME ,ORGANIZATION_CODE ,CREATION_DATE ,CREATED_BY ,LAST_UPDATE_DATE ,LAST_UPDATED_BY ,LAST_UPDATE_LOGIN ,REQUEST_ID ,SOURCE ,TEMPLATE_NAME ,RECORD_ID ,STATUS ,SR_ORGANIZATION_ID ,SR_INSTANCE_ID ,SR_INVENTORY_ITEM_ID ,STANDARD_COST');
